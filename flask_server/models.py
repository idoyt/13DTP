...
class Friendship(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True, nullable=False)
    user1_id = db.Column(db.Boolean, nullable=False)
    user2_id = db.Column(db.Boolean, nullable=False)
    is_friend = db.Column(db.Boolean, nullable=False)
    pending1 = db.Column(db.Boolean, nullable=False)
